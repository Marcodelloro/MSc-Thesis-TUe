...
eqns = [dS; dI; dD; dT1; dT2; dH; dE; dDelta1; dDelta1];
vars = [S I D T1 T2 H E delta1 delta2];
static_coefs = [alpha beta gamma epsilon sigma1 sigma2 tau1 tau2 lambda]; % Coefs
...
x0A = [S_data(1); I_data(1); D_data(1); T1_data(1); T2_data(1); H_data(1); E_data(1); 0.002; 5e-4];
...
w_dist = [w_delta1 w_delta2]; % vector of the process disturbances
...
guessed_vals = [alpha_val, beta_val, gamma_val, epsi_val,sigma1_val,...
