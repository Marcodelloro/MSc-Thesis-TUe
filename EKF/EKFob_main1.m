...
eqns = [dS; dI; dD; dT1; dT2; dH; dE; dAlpha; dBeta];
vars = [S I D T1 T2 H E alpha beta];
static_coefs = [gamma delta1 delta2 epsilon sigma1 sigma2 tau1 tau2 lambda]; % Coefs
...
x0A = [S_data(1); I_data(1); D_data(1); T1_data(1); T2_data(1); H_data(1); E_data(1); 0.6; 0.2];
...
w_dist = [w_alpha w_beta]; % vector of the process disturbances
...
guessed_vals = [gamma_val, delta1_val, delta2_val, epsi_val,...
