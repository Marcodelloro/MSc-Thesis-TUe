...
eqns = [dS; dI; dD; dT1; dT2; dH; dE; dEpsi; dSigma1; dSigma2];
vars = [S I D T1 T2 H E epsilon sigma1 sigma2];
static_coefs = [alpha beta gamma delta1 delta2 tau1 tau2 lambda]; % Coefs

%% Algorithm initialization

nstates = 10; % number of states - already augmented
...
x0A = [S_data(1); I_data(1); D_data(1); T1_data(1); T2_data(1); H_data(1); E_data(1); 0.03; 0.02; 0.005];
P0 = diag([5 50 5 5 5 5 5 50 50 50]);
...
w_dist = [w_epsi w_sigma1 w_sigma2]; % vector of the process disturbances
...
guessed_vals = [alpha_val, beta_val, gamma_val, delta1_val, delta2_val, tau1_val, tau2_val, lambda_val];
